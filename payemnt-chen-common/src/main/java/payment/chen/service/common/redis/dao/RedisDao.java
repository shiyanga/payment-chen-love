package payment.chen.service.common.redis.dao;

import com.alibaba.fastjson.JSON;
import org.springframework.beans.factory.annotation.Autowired;
import payment.chen.service.common.redis.annation.RedisFieldNotCache;
import payment.chen.service.common.redis.annation.RedisQuery;
import payment.chen.service.common.redis.model.BeanField;
import payment.chen.service.common.redis.util.RedisCacheManager;
...
//    public RedisDao(RedisDataBaseType redisDataBaseType) {
//        RedisCachePool pool = redisCacheManager.getRedisPoolMap().get(redisDataBaseType.toString());
