package payment.chen.service.common.redis.synchronize;//package MyDemo.redis.synchronize;
//
//
//import MyDemo.redis.dao.RedisDao;
//import MyDemo.redis.util.RedisCacheManager;
//import MyDemo.redis.util.RedisCachePool;
//import MyDemo.redis.util.RedisDataBaseType;
//import MyDemo.test.ThreadTest;
...
//    Logger log = Logger.getLogger(ThreadTest.class);
//	@Autowired
