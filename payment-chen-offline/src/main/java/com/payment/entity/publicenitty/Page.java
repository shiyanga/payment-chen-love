...
public class Page<T>{
    ...
    public static final class PageBuilder<T> {
        ...
        public PageBuilder withDraw(int draw) {
            this.draw = draw;
            return this;
        }
        ...
        public PageBuilder withStartOffset(int startOffset) {
            this.startOffset = startOffset;
            return this;
        }
        ...
        public PageBuilder withTotalRecord(int totalRecord) {
            this.totalRecord = totalRecord;
            return this;
        }
        ...
        public PageBuilder withResults(List<T> results) {
            this.results = results;
            return this;
        }

        public PageBuilder withParams(Map<String, Object> params) {
            this.params = params;
            return this;
        }

        public PageBuilder withBasePojoList(List<?> basePojoList) {
            this.basePojoList = basePojoList;
            return this;
        }
        ...
        public Page build() {
            ...
            page.setStartOffset(startOffset);
            page.setPageSize(pageSize);
            page.setTotalRecord(totalRecord);
            page.setTotalPage(totalPage);
            page.setResults(results);
            page.setParams(params);
            page.setBasePojoList(basePojoList);
            return page;
        }
    }
}